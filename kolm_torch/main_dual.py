...
#network = torch.load('trained_potential_model_{num_features}.pth')
...
for epoch in range(epochs):
    ...
    domain_size = 2*torch.pi/8 #physical domain size
...
torch.save( network, f"trained_potential_model_{num_features}.pth" )
